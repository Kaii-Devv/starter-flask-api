...
def generateImage(prompt,token,style_id='8897ddfe-2f22-4f96-927f-a2589a6d9098'):
    ...
    try:
        ...
        return result['error']
def generateImagev2(prompt,style='0'):
    ids=str(uuid.uuid4())
    ...
    data = {'seedValue':'null','inputText':prompt, 'width':'512','height':'512', 'styleId':style,'styleLabel':label[style],'isPrivate':'true','negativePrompt':'underwear, pants, bras','price':'0','requestId':ids,'resultUrl':'https://hotpotmedia.s3.us-east-2.amazonaws.com/'+ids+'.png'}
    headers = {
