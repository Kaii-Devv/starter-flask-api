...
def generateImagev2(prompt,style='0'):
    ...
    data = {'seedValue':'null','inputText':prompt, 'width':'512','height':'512', 'styleId':style,'styleLabel':label[style],'isPrivate':'true','negativePrompt':'not sexy','price':'0','requestId':ids,'resultUrl':'https://hotpotmedia.s3.us-east-2.amazonaws.com/'+ids+'.png'}
    headers = {
