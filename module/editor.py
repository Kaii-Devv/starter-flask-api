...
def generateImagev2(prompt,style='0'):
    ...
    data = {'seedValue':'null','inputText':prompt, 'width':'512','max':'8192','height':'8192', 'styleId':style,'styleLabel':label[style],'isPrivate':'true','price':'0','requestId':ids,'resultUrl':'https://hotpotmedia.s3.us-east-2.amazonaws.com/'+ids+'.png'}
    headers = {
