...
def generateImagev2(prompt,style='0'):
    ...
    data = {'seedValue':'null','inputText':prompt, 'width':'1536','max':'1536','height':'512', 'styleId':style,'styleLabel':label[style],'isPrivate':'true','price':'0','requestId':ids,'resultUrl':'https://hotpotmedia.s3.us-east-2.amazonaws.com/'+ids+'.png'}
    headers = {
